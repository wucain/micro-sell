...
(function (h) {
    ...
    (function (f) {
        var h = f.defaultOptions, n = f.doc, A = f.Chart, u = f.addEvent, F = f.removeEvent, D = f.fireEvent,
            q = f.createElement, B = f.discardElement, v = f.css, p = f.merge, C = f.pick, k = f.each, r = f.extend,
        ...
        r(A.prototype, {
            sanitizeSVG: function (a, c) {
                ...
                var a = this, c = a.container, e = [], b = c.parentNode, f = n.body, m = f.childNodes,
                ...
                var c = this, e = c.renderer, b = p(c.options.navigation.buttonOptions, a), f = b.onclick,
                    m = b.menuItems, g, d, h = b.symbolSize || 12;
